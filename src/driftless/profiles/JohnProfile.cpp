...
namespace driftless {
namespace profiles {
std::string JohnProfile::getName() { return PROFILE_NAME; }

int JohnProfile::getControlMode(op_control::EControlType control_type) const {
  int mode{};
...
void JohnProfile::setControlMode(op_control::EControlType control_type,
                                 int control_mode) {
  CONTROL_MODE_MAP[control_type] = control_mode;
}

op_control::EControllerAnalog JohnProfile::getAnalogControlMapping(
...
op_control::EControllerDigital JohnProfile::getDigitalControlMapping(
    op_control::EControl control) const {
