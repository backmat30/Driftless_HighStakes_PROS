#ifndef __JOHN_SKILLS_PROFILE_HPP__
#define __JOHN_SKILLS_PROFILE_HPP__
...
/// @brief User control profile for John during skills
/// @author Matthew Backman
class JohnSkillsProfile : public driftless::profiles::IProfile {
 private:
  /// @brief Name of the profile
  static constexpr char PROFILE_NAME[]{"JOHN_SKILLS"};
