...
/// @brief Namespace for auton code
/// @author Matthew Backman
namespace auton {

/// @brief Class for the orange robot's auton skills
/// @author Matthew Backman
class OrangeSkillsAuton : public IAuton {
 private:
  static constexpr char AUTON_NAME[]{"ORANGE_SKILLS"};
  ...
  /// @brief Starts the color sorter process
  void startColorSort();

  /// @brief Pauses the color sorter process
  void pauseColorSort();

  /// @brief Resumes the color sorter process
  void resumeColorSort();
  ...
  /// @brief Moves the arm to the score position
  void armGoScore();
  ...
  /// @brief Resets the x position of the robot
  void odomResetX();

  /// @brief Resets the y position of the robot
  void odomResetY();
  ...
  /// @brief Determines if the arm is at the ready position
  /// @return __bool__ true if the arm is at ready, false if otherwise
  bool isArmReady();
